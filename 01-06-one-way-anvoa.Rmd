...
### Traditional approach
To perform a traditional One-Way ANOVA, we can use the `aov` function. The first argument in the `aov` function is the formula and the second argument is the name of the dataset. Notice, that in the formula, we do not have to specifyboth contrasts because we have already applied the coding scheme directly to the categorical IV of `rank`.
```{r}
