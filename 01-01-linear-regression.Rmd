...
The `F value` or *F*-statistic conceptually provides a ratio of explained and unexplained variability to unexplained variability. Explained variability is how much the DV can be explained by IVs while unexplained variability is how much variabily is not explained by the DV.  
