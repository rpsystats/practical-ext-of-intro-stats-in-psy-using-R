...
The *p*-value or `Pr(>|t|)` of `<2e-16` is the probability of obtaining that particular *t*-statistic or more extreme assuming that the null hypothesis is true, which is the same value from the ANOVA source table.
