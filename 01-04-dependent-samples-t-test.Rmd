...
ggplot(datasetAnorexia, aes("", PostWeight - PreWeight)) +
  ...
  geom_errorbar(aes(ymin = dataset_summary$LL95CI, ymax = dataset_summary$UL95CI), width = 0.01, color = "#3182bd", alpha = 0.5) +
  geom_point(aes("", dataset_summary$mean), size = 3, color = "#3182bd", alpha = 0.5) +
