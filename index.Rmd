--- 
title: "A Practical Extension of Introductory Statistics in Psychology using R (Draft)"
author: "Ekarin Eric Pongpipat, M.A. & Giuseppe Miranda, M.S."
site: bookdown::bookdown_site
documentclass: book
bibliography: [book.bib, packages.bib]
biblio-style: apalike
link-citations: yes
description: "This book aims to provide a practical extension of introductory statistics typically taught in psychology into the general linear model (GLM) using R. Additionally, this book will extend more advanced univariate statistics in psychology into the GLM framework."
subtitle: "This book aims to provide a practical extension of introductory statistics typically taught in psychology into the general linear model (GLM) using R. Additionally, this book will extend more advanced univariate statistics in psychology into the GLM framework."
---
...
3. Statistical decision *(using an alpha ($\alpha$) = 0.05, two-tailed, which is the artribrary and ubiquituous convention in psychology)*
4. APA statement *(bare minumum)*
5. Visualization
...
This book will also not exhaustively review data manipulation, transformations, and visualization in R as there are other books that already do this well (e.g., [R for Data Science by Wickham & Grolemund](http://r4ds.had.co.nz/). This book is meant to be an living open-source book that can be edited by others. 

## Why R?
We chose to use R to analyze and write this book because R forces us to write out how we performed our analyses (and write helpful comments if we're nice). These codes allow us and others to re-analyze the data exactly as we have. This is not always the case with statistical softwares that use GUIs.

## Why should we should to you guys?
We are neuroscientist that regular utilize statsistics. We have had to self-teach and supplement our learning of different statistical analyses and wanted to share our knowledge with others. Hopefully, making it easier and more intuitive for others.