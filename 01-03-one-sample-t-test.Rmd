...
From this output, we can see that the *t*-statistic (`t`) is `41.762`, degrees of freedom (`df`) is `396`, and the `p-value` is `2.2e-16`, with professor's mean salary at \$113,706.50.
...
ggplot(datasetSalaries, mapping = aes("", salary)) +
  ...
  geom_point(aes("", dataset_summary$mean),
    size = 2,
    color = "#3182bd",
    alpha = .5
  ) +
